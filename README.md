...
```bash
git clone https://github.com/your-username/ff7-chronicle-mobile-starter
...
2. **Long-term:** After every 10 user messages, a separate AI call summarizes the conversation into per-character memory items (e.g., `cloud: 克劳德知道玩家对 Shinra 有戒心`). These persist in AsyncStorage and survive app restarts.
